export interface paths {
    "/sendings": {
         ...
         *     - Le type d'affranchissement : rapide ou économique
         *     - e-mail de notification,
         *     - Impression de l'adresse expéditeur,
         *     - Durée d'archivage : 0 an, 1 an, 3 ans, 6 ans ou 10 ans
                ...
                content: {
                    "multipart/form-data": {
                        ...
                        metadata?: {
                             ...
                             * @example doc_principal.pdf
                             */
                            name?: string;
                            /**
                             * @description redimensionnement du document
                             * @default true
                             * @example true
                             */
                            shrink?: boolean;
    ...
    "/sendings/{sending_id}/recipients/{recipient_id}/download_archive": {
         ...
         * @description Permet de télécharger au format PDF le courrier envoyé au destinataire dans le cas où l'option d'archivage a été choisie.
         */
        get: {
            parameters: {
                query?: never;
...
export interface components {
    schemas: {
        ...
        delivery_statuses_response: {
            /** @description
             *     Dans le cadre d'un envoi de courrier simple, seule l'option gestion des PND (plis non distribuables) peut faire l'objet d'un statut de distribution.
             *     - N : Numérisé
             *     <table border="1">
        ...
        document_response: {
            ...
            size: number;
            /**
             * @description Poids en octets du document converti
             * @example 139072
             */
        ...
        error_response: {
             ...
             *         <th>Description</th>
             *       </tr>
             *       <tr><td>SENDER_ADDRESS_LINE_1_TOO_LONG</td><td>La ligne d'adresse n°1 est limitée à 38 caractères</td></tr>
             *       <tr><td>SENDER_ADDRESS_LINE_2_TOO_LONG</td><td>La ligne d'adresse n°2 est limitée à 38 caractères</td></tr>
             *       <tr><td>SENDER_ADDRESS_LINE_3_TOO_LONG</td><td>La ligne d'adresse n°3 est limitée à 38 caractères</td></tr>
             *       <tr><td>SENDER_ADDRESS_LINE_4_TOO_LONG</td><td>La ligne d'adresse n°4 est limitée à 38 caractères</td></tr>
             *       <tr><td>SENDER_ADDRESS_LINE_5_TOO_LONG</td><td>La ligne d'adresse n°5 est limitée à 38 caractères</td></tr>
             *       <tr><td>SENDER_ADDRESS_LINE_6_TOO_LONG</td><td>La ligne d'adresse n°6 est limitée à 38 caractères</td></tr>
             *       <tr><td>SENDER_ADDRESS_LINE_6_WRONG_FORMAT</td><td>Le champ address_line_6 doit avoir le format [CODE_POSTAL] [VILLE], avec CODE_POSTAL sur 5 chiffres, lorsque le code pays vaut "FR"</td></tr>
             *       <tr><td>SENDER_COUNTRY_CODE_TOO_LONG</td><td>Le code pays est limité à 2 caractères</td></tr>
         ...
         * @enum {string}
         */
        recipient_postage_class: "IMPORTANT" | "IMPORTANT_INDUSTRIEL" | "PRIORITY" | "PRIORITY_INDUSTRIAL" | "ECONOMY" | "ECONOMY_INDUSTRIAL";
        ...
        sending_response: {
             ...
             */
            archiving_duration?: 0 | 1 | 3 | 6 | 10;
            return_envelope?: components["schemas"]["return_envelope_output"];
            /**
             * @description Gestion électronique des PND
             * @example false
             */
        ...
        return_envelope_output: {
            ...
            reference?: string;
        } & components["schemas"]["return_envelope"];
    };
    responses: never;
    parameters: {
        /** @description Identifiant du document */
